...
class FetchAnime {
    ...
    constructor(filters?: AnimeFilters, sort?: string, include?: 'categories' | 'mappings') {
        const queryString = QueryString.stringify({filters: filters, sort: sort, include: include}, {encode: false})
...
export default class Anime {
     ...
     */
    fetch (filters?: AnimeFilters, 
        sort?: string, 
        include?: 'categories' | 'mappings'): FetchAnime {
