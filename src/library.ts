...
class FetchLibrary {
    ...
    constructor(filters?: LibraryFilters, sort?: string, include?: string, auth?: KitsuAuthToken){
        const filterString: string = QueryString.stringify({filter: filters, sort: sort, include: include}, {encode: false})
...
export default class Library{
        ...
        */
        fetch(filters?: LibraryFilters, 
            sort?: string, include?: string, auth?: KitsuAuthToken): FetchLibrary  {
        ...
        */
        async fetchById (libraryEntryId:  number | string, auth?: KitsuAuthToken): Promise<any> {
         ...
         */
        async create(userId: number | string, data: CreateEntryData, auth: KitsuAuthToken): Promise<any> {
            const body = {
                data: {
                  type: "libraryEntries",
                  attributes: {
